    ...
    <table class="min-w-full border-collapse border border-gray-300">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="border px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Title</th>
                ...
                <th class="border px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actions</th>
            </tr>
        </thead>
        <tbody class="divide-y divide-gray-200">
            @foreach($tasks as $task)
            <tr class="hover:bg-gray-100">
                <td class="border px-6 py-4">{{ $task->id }}</td>
                <td class="border px-6 py-4">{{ $task->title }}</td>
                <td class="border px-6 py-4">{{ $task->description }}</td>
